...
model = tf.keras.models.load_model('rental_recommendation_model.h5')
...
# Debugging: Check if 'brand' column exists
print("Columns in rental_df:", rental_df.columns)
print("Columns in vehicle_df:", vehicle_df.columns)
...
async def recommend(user_input: UserInput):
    ...
    data_test = data_test[['id_user', 'id_rental', 'id_vehicle', 'rating', 'vehicle_name', 'colors', 'number_of_seats', 'vehicle_type', 'brand']]
